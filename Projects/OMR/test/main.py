...
def start(mode):
    ...
    sheet_dir_entry.insert(0, "E:\\Users\\angel\\Desktop\\失敗檔案")
    answer_file_entry.insert(0, "E:\\Users\\angel\\Documents\\SyncDocs\\Projects\\OMR\\test\\ans.xlsx")
    output_name_entry.insert(0, "rt.xlsx")
